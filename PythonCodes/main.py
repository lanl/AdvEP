...
if args.todo=='train':
    ...
    test_acc /= len(test_loader.dataset)
    print(path,1)
elif args.todo=='auto-attack-resume':
    print('Auto Attacking')
    test_acc = auto_attack_resume(model, test_loader, args.T1, criterion, device,args.load_path,args.softmax, args.image_print,args.attack_step, args.predict_step,args.attack_norm)
    test_acc /= len(test_loader.dataset)
    print(path,1)
