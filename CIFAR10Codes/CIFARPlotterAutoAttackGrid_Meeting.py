...
def adv_img_plot(invert=0):
    ...
    label_cnn_template = 'AA_Labels_Norm_100_Train_Eps_%d_Test_Eps_%d_Seed_%d.npy'
    img_cnn_template = 'AA_Adversarial_Norm_100_Images_Train_Eps_%d_Test_Eps_%d_Seed_%d.npy'
    label_ep_template = 'AA_Norm_100_Labels_Eps_%d_Max_Evals_%d.npy'
    img_ep_template = 'AA_Norm_100_Adversarial_Images_Eps_%d_Max_Evals_%d.npy'
    label_cnnrelu_template = 'AA_Labels_Norm_100_Train_Eps_%d_Test_Eps_%d_Seed_%d.npy'
    img_cnnrelu_template = 'AA_Adversarial_Norm_100_Images_Train_Eps_%d_Test_Eps_%d_Seed_%d.npy'
    img_vit_template = 'AA_Norm_100_Adversarial_Images_Eps_%d_Patch_4_Augment_1_Seed_%d.npy'
    label_vit_template = 'AA_Norm_100_Labels_Eps_%d_Patch_4_Augment_1_Seed_%d.npy'
    model_str = 'relu'
    max_evals=1000
    ...
    print(axslabel)
    plt.tight_layout()
    plt.savefig(dname+'/AA_Attack_Invert_%d.pdf'%(invert))
