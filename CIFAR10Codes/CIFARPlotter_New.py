...
def adv_img_plot():
    ...
    file_loc = ['/results/EP/mse/2023-05-22/12-28-59_gpu0/','/results/EP/mse/2023-05-22/12-31-48_gpu0/','/results/BPTT/mse/2023-05-22/13-52-18_gpu0/','/results/EP/cel/2023-06-14/17-04-29_gpu0/','/results/BPTT/cel/2023-05-30/15-31-49_gpu0/']
    ...
    plt.tight_layout()
    plt.savefig(dname+'/Adv_Image_Grid_New.png')
adv_img_plot()